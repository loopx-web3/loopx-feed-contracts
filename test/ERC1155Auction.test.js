...
contract("ERC1155Auction", (accounts) => {
    ...
    before(async () => {
        ...
        await NitaToken.new({ from: accounts[0] }).then(function (instance) {
    ...
    describe("auction with single token", () => {
        ...
        it("result auction", async () => {
            ...
            assert.equal(await nitaerc1155token_contract.balanceOf(accounts[9], tokenId), 1);
    ...
    describe("auction with multiple tokens", () => {
        it("working with multiple tokens", async () => {
            ...
            //Token transfered correctly
            assert.equal(await nitaerc1155token_contract.balanceOf(accounts[6], tokenId), 1);
            ...
            //Token transfered correctly
            assert.equal(await nitaerc1155token_contract.balanceOf(accounts[8], tokenId), 1);
